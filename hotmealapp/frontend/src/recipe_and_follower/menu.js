    ...
    function () {
        {
            ...
            function init() {
                ...
                document.getElementsByClassName("favoriteNumberBorder")[0].innerHTML = favoriteNumber;
                document.getElementsByClassName("likeNumberBorder")[0].innerHTML = likeNumber;
            }
            ...
            function initDetails() {
                ...
                document.getElementsByClassName("personFollowing")[0].innerHTML = folloingNumber;
...
function favorite() {
    alert("favorite+1");
    fav=parseInt(document.getElementsByClassName("favoriteNumberBorder")[0].innerHTML);
    fav+=1;
    document.getElementsByClassName("favoriteNumberBorder")[0].innerHTML = fav;
}
function like() {
    alert("like+1");
    fav=parseInt(document.getElementsByClassName("likeNumberBorder")[0].innerHTML);
    fav+=1;
    document.getElementsByClassName("likeNumberBorder")[0].innerHTML = fav;
}
function follow() {
    alert("like+1");
    fav=parseInt(document.getElementsByClassName("personFollowing")[0].innerHTML);
    fav+=1;
    document.getElementsByClassName("personFollowing")[0].innerHTML = fav;
}
